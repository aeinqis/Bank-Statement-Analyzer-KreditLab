...
_RP_EXCLUDE_NAMES = frozenset({
    ...
    "BULK SALARY", "BULK DUITNOW", "BANK FEES", "FD/INTEREST", "LOAN REPAYMENT",
    ...
    "SOCSO", "LHDN", "HRDF",
    "BILLS", "BILL PAYMENT", "BILL PAYMENT TO FIN", "BILL TO FIN",
    "TRANSFER FEE", "OTHER TRANSFER FEE", "FUND", "FUND TRANSFER",
    "TO SAVINGS", "SAVINGS",
...
_FINANCIER_C11_EXCLUDE_RE = re.compile(
    ...
    r"REVERSAL|REFUND|CARD|SHARE|EQUITY)\b|SERVICE\s+CHARGE",
    re.IGNORECASE,
)
